        ...
        $input_club = trim($_POST["club"])
         ...
         if(empty ($name_err) && ($club_err) && ($position_err) && ($number_err)){
                ...
                if(stmt = mysqli_prepare($link, $sql)){
                    mysqli_stmt_bind_param($stmt, "sssss", $param_name, $param_club, $param_position, $param_number, $param_id);        
$param_name = $name;
$param_club = $club;
...
if($stmt = mysqli_prepare($link, $sql)){
    ...
    $number = $row["number"];
        ...
        header("location: errorpublications.php");
        exit();
    }
...
<a href="publications.php" class ="btn btn-default">Cancel</a>
</form>
    </div>
</body>
</html>
